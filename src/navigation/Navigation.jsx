...
import Wyniki from '@/navigation/Wyniki'
      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav className="flex items-center justify-between p-6 lg:px-8 xl:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end xl:flex xl:flex-1 xl:justify-end">
            <a href="https://www.pzbs.pl/" target="_blank" rel="noreferrer" className="text-sm font-semibold leading-6 text-gray-900">
              PZBS <span aria-hidden="true">&rarr;</span>
            </a>
          </div>
        </nav>
